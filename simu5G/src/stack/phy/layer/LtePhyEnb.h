...
class LtePhyEnb : public LtePhyBase
{
  ...
  protected:
    ...
    /**
     * convoy architecture
     * convoy control broadcast interval
     */
    double convoyCtrlBroadcastInterval_;
    ...
    /**
     * convoy architecture
     * self message to trigger convoy control broadcast
     */
    omnetpp::cMessage *convoyCtrlBroadcastStarter_;
     ...
     * Convoy Architecture
     */
    void handleBroadcastPkt(UserControlInfo* lteinfo, LteAirFrame* frame);
