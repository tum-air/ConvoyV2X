...
//    std::map<MacNodeId, L3Address> x2Address_;
     ...
     * Convoy architecture
     */
    std::vector<int> _id_list_convoys;
    std::map<int, std::vector<MacNodeId>> _cluster_map;
...
//    }
     ...
     * Convoy architecture
     */
    void notifyConvoy(int id);
    void deNotifyConvoy(int id);
    int getMaxIdConvoy();
    int getMaxIdCluster(int convoy_id);
    void notifyCluster(int convoy_id, int cluster_id, MacNodeId cluster_manager);
    void deNotifyCluster(MacNodeId cluster_manager);
    MacNodeId getManagerId(int convoy_id, int cluster_id);
    int getClusterId(int convoy_id, MacNodeId cluster_manager);
};
